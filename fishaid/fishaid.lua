addon.name      = 'FishAid';
addon.author    = 'Thorny updated by Brattycatty';
addon.version   = '1.0.1';
...
ashita.events.register('d3d_present', 'BotAPI_HandleRender', function ()
    -- Update the FishAid font object..
    if (state.Font ~= nil and state.Font.visible == true) then
        -- Update the current settings font position..
        state.Settings.Font.position_x = state.Font.position_x;
        state.Settings.Font.position_y = state.Font.position_y;
    end
